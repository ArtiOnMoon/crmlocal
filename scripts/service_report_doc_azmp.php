...
$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('../templates/service_report_azmp_v1.docx');

$templateProcessor->setValue('service_id',$on->get_order());
...
header('Content-Disposition: attachment; filename="'.$service_id.' - '.$row2['vessel_name'].' - SR.docx'.'"');
