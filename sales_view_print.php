...
<table class="print_table">
    ...
    <tr class="border_bottom">
        ...
        <td></td>
        <td class="align_right"><strong class="head_text">Quotation</strong></td>
    </tr>
    <tr></tr>
</table>
<br>
<table class="print_table3" width="100%">
    ...
    <tr>
        <td><?php echo $row['our_full_name']; ?></td>
        <td><strong>Date:</strong></td>
        <td><?php echo $row['sales_date']; ?></td>
    </tr>
    <tr>
        <td><?php echo $row['our_inv_addr']; ?></td>
        <td><strong>Valid until:</strong></td>
        <td><?php echo $date;?></td>
    </tr>
    <tr>
        <td><?php echo $row['our_inv_addr2']; ?></td>
    </tr>
    <tr>
        <td><?php echo $row['our_country']; ?></td>
    </tr>
    ...
    <tr>
        ...
        <td rowspan="2"><?php echo $row['sales_delevery_terms']; ?></td>
    </tr>
    <tr>
    ...
    <div>
        <table class="print_table2">
            <thead>
                <th width="10px">№</th>
                <th>Description</th>
                <th class="align_left">Delivery</th>
                <th class="align_left" width="40px">Q-ty</th>
...
if($result->num_rows>0){
    while($sales_cont = $result->fetch_assoc()){
        $scont_delivery=($sales_cont['scont_delivery']=='')?'in stock':$sales_cont['scont_delivery'];
        ?>
        <tr>
            <td><?php echo $i++;?></td>
...
?>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: right; border:0;"><b>Total: </b></td><td class="align_right"><strong><?php echo number_format($row['sales_total'],2,',',' ');?></strong></td>
        </tr>
        <tr>
            <td colspan="3" style="border:0;"></td>
            <td colspan="2" style="text-align: right; border:0;"><b>Currency: </b></td><td class="align_right"><?php echo $row['curr_name'];?></td>
        </tr>
        <tr>
            <td colspan="3" style="border:0;"></td>
            <td colspan="2" style="text-align: right; border:0;"><b>Incl. VAT: </b></td><td class="align_right"><?php echo number_format( $row['sales_total_vat'],2,',',' ');?></td>
        </tr>
        </table>
    </div>
    <?php
